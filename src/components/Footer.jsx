    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-green-500">Juice Bar</span>
            </div>
            <p className="text-gray-400 mb-4">
              Serving freshly squeezed juices made with 100% fresh ingredients.
              Based in Anaheim, CA and proudly catering to Los Angeles and Orange County.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/menu" className="text-gray-400 hover:text-green-500 transition-colors">Menu</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-green-500 transition-colors">About Us</Link>
              </li>
              <li>
                <Link to="/catering" className="text-gray-400 hover:text-green-500 transition-colors">Catering</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>(714) 555-JUICE</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>hello@juicebar.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Juice Bar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
