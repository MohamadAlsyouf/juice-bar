const menuItems = [
  {
    ...
    description:
      "Pure, freshly pressed sugarcane juice. Naturally sweet and incredibly refreshing.",
    price: "$10+",
    emoji: "🎋",
  ...
  },
  {
    name: "Orange Juice",
    description:
      "Classic freshly squeezed orange juice. Bursting with vitamin C and sunshine.",
    price: "$10+",
    emoji: "🍊",
  ...
  },
  {
    name: "Mango Juice",
    description:
      "Sweet and tropical mango juice made from ripe, handpicked mangoes.",
    price: "$10+",
    emoji: "🥭",
  ...
  },
  {
    name: "Lemon Juice",
    description:
      "Refreshing pure lemon juice. Perfect for a tangy, zesty kick.",
    price: "$10+",
    emoji: "🍋",
  ...
  },
  {
    ...
    description:
      "A refreshing blend of zesty lemon and cool mint leaves. Ultimate summer drink.",
    price: "$10+",
    emoji: "🍃",
  ...
  },
  {
    ...
    description:
      "Sweet strawberries perfectly balanced with tangy lemon. A delightful combination.",
    price: "$10+",
    emoji: "🍓",
  ...
  },
  {
    ...
    description:
      "Light and hydrating watermelon juice. The perfect thirst quencher.",
    price: "$10+",
    emoji: "🍉",
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-500 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 max-w-2xl mx-auto">
            All our juices are made fresh to order using 100% natural
            ingredients. No added sugar, no preservatives.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 bg-green-100 rounded-2xl p-8 text-center">
          ...
          <p className="text-green-700 max-w-2xl mx-auto">
            Want a special blend? We're happy to create custom juice
            combinations for you. Just ask our friendly staff for
            recommendations!
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <div className="bg-white rounded-xl shadow-md p-6 w-48">
              ...
              <p className="text-gray-500 text-sm">12 oz -- $10</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6 w-48 border-2 border-green-500">
              ...
              <p className="text-gray-500 text-sm">16 oz -- $12</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 w-48">
              ...
              <p className="text-gray-500 text-sm">24 oz -- $14</p>
            </div>
          </div>
        </div>
      </div>
